...
do
	...
	python3 evaluate_target_word_test_lower_surprisal.py --data ../data/colorlessgreenRNNs --checkpoint /om/group/cpl/language-models/colorlessgreenRNNs/hidden650_batch128_dropout0.2_lr20.0.pt --prefixfile prefixes.txt --surprisalmode True --outf surgical_gradient_r2_decrease_FINAL_$hidden_value.txt --modify_cell True --surgical_difference $hidden_value
done
